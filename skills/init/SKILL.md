---
name: init
description: Initialize or reset Mary Workflow v3 in the current project. Use when the user invokes /mw-init or asks to initialize Mary workflow.
---
...
6. Tell the user the next step is `/mw-plan`.
